...
namespace AutoChess
{
    public class GameHUD : MonoBehaviour
    {
        ...
        readonly System.Collections.Generic.List<FloatingText> floaters = new();
        ...
        {
            GUILayout.BeginArea(new Rect(10, 10, 480, 220), GUI.skin.box);
        ...
        {
            if (inspector == null)
                Debug.LogWarning("GameHUD: Inspector reference is not assigned. " +
                                 "The unit info panel (and the Sell button) will not appear. " +
                                 "Drag the Inspector component into GameHUD.Inspector in the Inspector.");
        ...
        void DrawStatusPanel()
        {
            ...
            if (rounds.LastReward > 0 || rounds.LastDamageTaken > 0)
            {
                ...
                string line = $"Last result: {outcome}, +{rounds.LastReward}g  " +
        ...
        void DrawShopSlot(int i, bool prep)
        {
            ...
            if (data == null) label = "(empty)";
                ...
                $"Range {data.attackRange}  ASPD {data.attackSpeed:0.#}\n" +
                $"{data.cost}g";
